...
namespace LTQ_Bai3._3.Controllers
{
    public class LTQ_HTMLHelperController : Controller
    {
        // GET: LTQ_HTMLHelper
        ...
        public ActionResult Register()
        {
            ...
            "Shopping ,";
            if (Request["Sport"].ToString().Contains("true")) fvr += "Sport,";TempData["Favourist"] = fvr;
            return View();
        }
    }
}
